...
class TransformerExtension:
    ...
    def get_value_type_by_resource_type(self, t):
        raise OverloadException(
            "Overload this method to convert types from the resources to ValueTypes."
        )

    def set_token_meta_data(self, token_name: str):
        raise OverloadException(
            "Overload this method to set certain meta data if a token is transformed."
        )

    def get_meta(self):
        raise OverloadException(
            "Overload this method to return the meta data of this instruction."
        )
